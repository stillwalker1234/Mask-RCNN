...
def proposal_layer(rpn_cls_prob_reshape_P2, rpn_bbox_pred_P2, \
    ...
    if cfg_key == 'TEST':
        ...
        fake_labels = np.ones((rpn_rois.shape[0],), dtype=np.int32)

        return leveled_rois[0], leveled_rois[1], leveled_rois[2], leveled_rois[3], leveled_rois[4], rpn_rois, lens_np, fake_labels
